...
-- Policies: PUBLIC WRITE for messages (Anonymous submissions allowed)
create policy "Anonymous Submit Message" on messages for insert with check (true);

-- Policies: ADMIN WRITE (Only authenticated users can manage data)
